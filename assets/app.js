...
// Navegação dos estudos — função explícita para evitar falhas de clique/cache.
function abrirEstudo(id) {
  ...
  ESTADO = { ...ESTADO, tela: "estudo", estudoId: estudo.id, fase: 0, chatAberto: false, configAberto: false };
  render();
